...
var (
	ApiVersion = builders.NewApiVersion("simple.io.example", "v1").WithResources(
		simple.SimpleDeepOneStorage,
		builders.NewApiResource( // Resource status endpoint
			simple.InternalDeepOneStatus,
			...
			&simple.DeepOneStatusStrategy{builders.StatusStorageStrategySingleton},
		))
